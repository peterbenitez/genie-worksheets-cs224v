"""
LLM-Based Yelp User Simulator for Automated Testing

This module implements an LLM-powered simulator that generates realistic user
conversations for Yelp restaurant testing.
"""
...
from yelp_profiles import YelpUserProfile
...
class YelpUserSimulator:
    """
    Simulates realistic user conversations using an LLM.
    """

    def __init__(
        self,
        profile: YelpUserProfile,
